...
success_view_class = import_string(getattr(settings, "CRYPTOMUS_SUCCESS_VIEW_CLASS", "django_cryptomus.views.SuccessCryptomusView"))
callback_view_class = import_string(getattr(settings, "CRYPTOMUS_CALLBACK_VIEW_CLASS", "django_cryptomus.views.CallbackCryptomusView"))
